...
'''常用的运算符
     ...
     4.布尔运算符
     5.位运算符'''
                                    #1.什么叫模块_模块化编程的好处.算数运算符
print('1.什么叫模块_模块化编程的好处.算数运算符')
print('------------标准运算符-------------')
print(1+1)   #加法运算
print(1-1)   #减法运算
print(2*4)   #乘法运算
...
print(9//4)     #2
print(-9//-4)   #2
print(-9//4)    #-3   一正一负的整除公式：向下取整（高斯取整函数）
print(9//-4)    #-3
print(9%-4)     #-3   一正一负的取余公式：余数=被除数-除数*商    9-（-4）*（-3）=9-12=-3
print(-9%4)     #3                                          -9-4*（-3）=-9+12=3
print('------------取余运算符-------------')
print(11%2)  #取余运算
print('------------幂运算符-------------')
print(2**2)  #幂运算（表示2的2次方）
print(2**3)  #幂运算（表示2的3次方）   2*2*2=8
